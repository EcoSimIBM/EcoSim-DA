...
void PhysicalGenome::crossover(vector<GENETYPE>* mother, vector<GENETYPE>* father, short bebe_gender, unsigned char p)
{
	//MRE RandomGoodGene
	...
	setPersuasion(p);
	if (persuasion > 255) persuasion = 255;
	if (persuasion < 0) persuasion = 0;
}
