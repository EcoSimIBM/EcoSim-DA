...
public:
	...
	void incPersuasionMalePrey(unsigned char a)				{ persuasionTotalMalePrey += a; };
	void incPersuasionMalePred(unsigned char a)				{ persuasionTotalMalePred += a; };
	void incPersuasionFemalePrey(unsigned char a)				{ persuasionTotalFemalePrey += a; };
	void incPersuasionFemalePred(unsigned char a)				{ persuasionTotalFemalePred += a; };
