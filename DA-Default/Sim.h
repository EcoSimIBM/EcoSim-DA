...
public:
	...
	unsigned char getPersuasionChar()		{ return phGenome.getPersuasionChar(); };
	...
	float calculationEnergyAction(float, int, float, float, unsigned char, Ecosystem *);
